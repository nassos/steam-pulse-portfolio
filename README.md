...
### トップページ
新着 / 今週 / 注目 / 近日 / 無料 / セール / ジャンル / 日本語対応 の 8 軸ナビゲーション。統計バーで「日本語対応 736 件 / 日本人プレイヤー人気 477 件 / 隠れ良作 129 件 / 直近 30 日新作 21 件 / 全 1,102 件」を提示。

![Steam Pulse JP トップページ](./screenshots/top-page.png)

### ジャンル一覧 (89 ジャンル × 2,500+ ゲーム)
Steam 新作タグから自動分類した全 89 ジャンルを 1 画面で俯瞰。各ジャンルカードに代表作プレビュー付き。

![ジャンル一覧](./screenshots/genres-index.png)

### ジャンル詳細 (例: アドベンチャー)
ジャンル統計サマリ (全 344 件 / 日本語対応 240 件 / セール 72 件 / 無料 37 件 / 平均スコア 8.7) + 日本人プレイヤー TOP 6 + 新作グリッド。「日本人プレイヤー数順」フィルタへの導線も配置。

![ジャンル詳細 - アドベンチャー](./screenshots/genre-detail.png)

### 個別ゲームページ (例: Žolík、2026-05-11 リリース)
Steam 公式言語サポート + 日本語レビュー集計の独立判定を可視化。「字幕日本語なし / 公式日本語表記なし / 音声日本語なし (英語音声)」のように個別フラグを分けて表示し、ユーザーが日本語対応の実態を即座に判断できる設計。Steam ストアへの導線も配置。

![個別ゲーム詳細](./screenshots/game-detail.png)
